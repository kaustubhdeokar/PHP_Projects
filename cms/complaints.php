...
<body>
    <p class="toright">
      <a href="adduser.php">Click for new users login.</a>
      <br>
      <a href="checkstatus.php">Click for status of user(Existing)</a>
    ...
    <div class="container">
        ...
        //here we check that the user exists in the user table when he/she enters the complaint.
                ...
                if($temp!=1){
                    echo "<label1>please register</label1>";
                }
                else{
